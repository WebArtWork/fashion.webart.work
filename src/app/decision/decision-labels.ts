...
export const DECISION_VISIBILITY_OPTIONS: {
	...
	{
		value: 'public-summary-private-details',
		label: 'Публічний огляд, приватні деталі',
	},
	{ value: 'private', label: 'Приватний' },
	{
		value: 'shared-with-selected-users',
		label: 'Доступ вибраним користувачам',
	},
	{
		value: 'shared-with-owners-tenants',
		label: 'Доступ власникам і орендарям',
	},
	{
		value: 'shared-with-stylist-boutique-contractor-manager',
		label: 'Доступ стилісту, бутіку, підряднику, керуючому',
	},
];
...
export const DECISION_VISIBILITY_LABELS: Record<DecisionVisibility, string> =
	Object.fromEntries(
